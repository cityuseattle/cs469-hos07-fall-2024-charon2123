...
class Graph():
    def __init__(self, vertices) -> None:
        self.V = vertices
        #Initialize a matrix of siz nxn, knowing n is the number of vertices.
    ...
    def djikstra(self, source):
        ...
        for _ in range(self.V):
            ...
            only if the current distance is greater than new distance and the vertex
